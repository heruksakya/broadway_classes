...
# This appends the value 3 in both 'a' and 'b' because they both refer to the same object [1, 2, 3]

b = a.copy() # This makes a shallow copy of 'a' and assigns it to 'b'

# Now if we append a value to 'b', it does not change 'a'
...
b = a.copy()
b[0][1] = 5
print(b) # Result is [[1, 5, 3], 4]

# But this also changes the value in variable 'a' even it 'b' is the copy of 'a'
...
b = deepcopy(a)
b[0][1] = 2
print(b) # Result is [[1, 2, 3],4]
print(a) # This doesn't change value in variable 'a'. Result is [[1, 5, 3], 4]
